(function(window, document, $) {
  ...
  */
  ...
  var pluginName = 'jqSignature',
      ...
      canvasFixture = '<canvas id="myCanvas"></canvas>';
  ...
  Signature.prototype = {
    ...
    _renderCanvas: function() {
      if (this.drawing) {
        ...
        var sessionflag=$("#sessionflag").val();
        var lastX=this.lastPos.x;
        var lastY=this.lastPos.y;
        var pointcolor=$("#colorCount").val();
         //获取canvas对象
        var canvas = document.getElementById('myCanvas');
        //获取画布的宽高
        var width=canvas.width;
        var height=canvas.height;
		//var pointsize=$("#lineWidth").val();
        /*var pointcolor="";
        var pointsize="";*/
		$("#pointxy").val(sessionflag+"/"+width+"/"+height+ "/"+pointcolor+"/"+lastX+"/"+lastY+","+$("#pointxy").val());
