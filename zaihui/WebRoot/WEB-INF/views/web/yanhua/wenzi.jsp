...
<html> 
	...
	<div style="height:700px;overflow:hidden;">
		...
		<div class="city"><img src="<%=basePath%>static/yanhua/img/city.png" alt="" /></div>
		<img src="<%=basePath%>static/yanhua/img/moon.png" alt="" id="moon" style="visibility: hidden;"/>
		<div style="display:none">
			<div class="shape">顺心666</div>
	...
	<script>
		...
		function animate(){
			...
			var showTextX=18;//这个数值越大显示文字的概率就越大
			var newTime = new Date();
            if(newTime-lastTime>500+(window.innerHeight-767)/2){
				var random = Math.random()*100>showTextX?true:false;
